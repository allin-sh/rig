...
import type { StorageChannel } from './types';
...
export const channelGateway = {
  ...
  create: (info: StorageChannel) => invoke<void>('create_channel', { info }),

  update: (info: StorageChannel) => invoke<void>('update_channel', { info }),
